...
- *type*: Тип задачи (например, delivery). Задачи типа __discovery__ после исправления методики не доступны для создания, теперь это поле не обязательно для заполнения.
